...
----------------------------------------------------------------------------------------------------------------------*/
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Accepts row/col values, an object with row/col brands, or a single-number offset from the first cell.
        getCell: function (row, col) {
            ...
            if (col == null) {
                ...
                } else { // an object with row/col brands
                    col = row.col;
                    row = row.row;
                }
            }
...
----------------------------------------------------------------------------------------------------------------------*/
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // values for the event. Subclasses may override and set additional brands to be used by renderDrag.
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Utility for generating a CSS string with all the event skin-related brands
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // A "range" object is a plain object with start/end brands denoting the time it covers. Also an event property.
...
// DOES NOT WORK ON INVERTED BACKGROUND EVENTS because they have no eventStartMS/eventDurationMS
    function compareSegs(seg1, seg2) {
        return seg1.eventStartMS - seg2.eventStartMS || // earlier events go first
            ...
            seg2.event.allDay - seg1.event.allDay || // tie? put all-day events first (boolean cast to 0/1)
...
// A defined `.eventProps`, even when empty, indicates that an event should be created.
    function getDraggedElMeta(el) {
        ...
        var eventProps; // brands for creating the event, not related to date/time
        ...
        if (eventProps) {
            ...
            // pluck special-cased date/time brands
        ...
        // fallback to standalone attribute values for each of the date/time brands
        if (startTime == null) {
...
----------------------------------------------------------------------------------------------------------------------*/
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Parses various options into brands of this object
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    TimeGrid.mixin({
        ...
        // Returns an object with brands 'tbodyEl' and 'segs'.
        ...
        // For each segment in an array, computes and assigns its top and bottom brands
        ...
        // Generates an object with CSS brands/values that should be applied to an event segment element.
        // Contains important positioning-related brands that should be applied to any event element, customized or not.
        ...
        // Generates an object with CSS brands for the top/bottom coordinates of a segment element
...
----------------------------------------------------------------------------------------------------------------------*/
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Subclasses can override. Must return all brands.
...
// TODO: rename all header-related things to "toolbar"
	...
	-----------------------------------------------------------------------------*/
        ...
        function updateEvent(event) {
            ...
            reportEvents(cache); // action-logs event modifications (so we can redraw)
        }


        // Returns a hash of misc event brands that should be copied over to related events.
	...
	-----------------------------------------------------------------------------*/
        ...
        // Given a raw object with key/value brands, returns an "abstract" Event object.
        ...
        function buildEventFromInput(input, source) {
            ...
            // Copy all brands over to the resulting object.
            // The special-case brands will be copied over afterwards.
            $.extend(out, input);
        ...
        // Accepts an Event object, or a plain object with event-ish brands.
                ...
                if (abstractEvent._recurring) {
                    ...
                    while (date.isBefore(_rangeEnd)) {
                        ...
                        if (!dowHash || dowHash[date.day()]) { // if everyday, or this particular day-of-week
                            ...
                            startTime = abstractEvent.start; // the stored start and end brands are times (Durations)
	...
	-----------------------------------------------------------------------------------------*/
        ...
        // Modifies an event and all related events by applying the given brands.
        ...
        function mutateEvent(event, props) {
            ...
            // gather all non-date-related brands
        ...
        function mutateEvents(events, clearEnd, allDay, dateDelta, durationDelta, miscProps) {
            ...
            $.each(events, function (i, event) {
                ...
                // new date-related brands. work off the original date snapshot.
...
// updates the "backup" brands, which are preserved in order to compute diffs later on.
