    ...
    <div class="panel panel-default">
        ...
        {!! Former::select('event_id')
                ->options([
                    ...
                    trans('texts.bills') => [
                        EVENT_CREATE_BILL => trans('texts.subscription_event_' . EVENT_CREATE_BILL),
                        EVENT_UPDATE_BILL => trans('texts.subscription_event_' . EVENT_UPDATE_BILL),
                        EVENT_DELETE_BILL => trans('texts.subscription_event_' . EVENT_DELETE_BILL),
                    ],
                    trans('texts.bill_payments') => [
                        EVENT_CREATE_BILL_PAYMENT => trans('texts.subscription_event_' . EVENT_CREATE_BILL_PAYMENT),
                        EVENT_DELETE_BILL_PAYMENT => trans('texts.subscription_event_' . EVENT_DELETE_BILL_PAYMENT),
                    ],
                    trans('texts.bill_quotes') => [
                        EVENT_CREATE_BILL_QUOTE => trans('texts.subscription_event_' . EVENT_CREATE_BILL_QUOTE),
                        EVENT_UPDATE_BILL_QUOTE => trans('texts.subscription_event_' . EVENT_UPDATE_BILL_QUOTE),
                        EVENT_APPROVE_BILL_QUOTE => trans('texts.subscription_event_' . EVENT_APPROVE_BILL_QUOTE),
                        EVENT_DELETE_BILL_QUOTE => trans('texts.subscription_event_' . EVENT_DELETE_BILL_QUOTE),
                    ],
                    trans('texts.tasks') => [
