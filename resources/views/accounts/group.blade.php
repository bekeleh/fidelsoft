...
<div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
    <label for="name" class="col-md-3 control-label">{{ trans('texts.group_name') }}</label>
    <div class="col-md-6 required">
        <p>previous group name here...</p>
...
<div class="col-md-12">
    <table class="table table-striped permissions">
        ...
        @foreach ($permissions as $area => $area_permission)
            <!-- handle super admin and action-logs, and anything else with only one option -->
