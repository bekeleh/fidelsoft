        ...
        <div class="panel-body">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control"
                                   data-bind="value: account_name, valueUpdate: 'afterkeydown', attr: {name: 'bank_accounts[' + $index() + '][account_name]'}"/>
                            <input type="text" style="display:none"
                                   data-bind="value: hashed_account_number, attr: {name: 'bank_accounts[' + $index() + '][hashed_account_number]'}"/>
                        </td>
            ...
            <div class="col-lg-12 col-sm-12" data-bind="visible: page() == 'import'" style="display:none">
                <div class="row panel" style="padding-top:10px;padding-bottom:12px;">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control"
                               data-bind="value: $root.filter, valueUpdate: 'afterkeydown'"
