        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading" style="color:white;background-color: #777 !important;">
                    <h3 class="panel-title in-bold-white">{!! trans('texts.settings') !!}</h3>
                </div>
                        ...
                        <ul class="nav nav-tabs" role="tablist" style="border: none">
                            <li role="presentation" class="active">
                                <a href="#link" aria-controls="link" role="tab"
                                   data-toggle="tab">{{ trans('texts.link') }}</a>
                            </li>
                            <li role="presentation">
                                <a href="#navigation" aria-controls="navigation" role="tab"
                                   data-toggle="tab">{{ trans('texts.navigation') }}</a>
                            </li>
                            <li role="presentation">
                            ...
                            <li role="presentation">
                                <a href="#custom_css" aria-controls="custom_css" role="tab"
                                   data-toggle="tab">{{ trans('texts.custom_css') }}</a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <ul class="nav nav-tabs" role="tablist" style="border: none">
                                        ...
                                        <li role="presentation">
                                            <a href="#form" aria-controls="form" role="tab"
                                               data-toggle="tab">{{ trans('texts.form') }}</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tab-content">
...
&lt;/script&gt;</pre>
                        ...
                        <div class="panel-body" id="domainModalHelp" style="display:none">
                            ...
                            <p>Once this is setup please send an email to {{ env('CONTACT_EMAIL') }} and we'll complete
                                the process.</p>
                        </div>
