            ...
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist" style="border: none">
                    ...
                    <li role="presentation"><a href="#styles" aria-controls="styles" role="tab"
                                               data-toggle="tab">{{ trans('texts.styles') }}</a></li>
                    ...
                    <li role="presentation"><a href="#margins" aria-controls="margins" role="tab"
                                               data-toggle="tab">{{ trans('texts.margins') }}</a></li>
                    <li role="presentation"><a href="#header" aria-controls="header" role="tab"
                                               data-toggle="tab">{{ trans('texts.header') }}</a></li>
                    ...
                    @if ($account->isEnterprise() && $account->background_image_id)
                        <li role="presentation"><a href="#background" aria-controls="footer" role="tab"
                                                   data-toggle="tab">{{ trans('texts.background') }}</a></li>
                    @endif
                </ul>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    {!! trans('texts.customize_help', [
                                            ...
                                            'forum_link' => link_to('https://www.fidel.com/forums/forum/support', trans('texts.support_forum'), ['target' => '_blank']),
                                        ]) !!}<br/>
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-primary" href="{{ config('ninja.video_urls.custom_design') }}"
                               target="_blank">{{ trans('texts.video') }}</a>
                        </div>
