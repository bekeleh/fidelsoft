                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-sm-8 help-block">
                                <input type="text" class="form-control" onfocus="$(this).select()" readonly
                                       value="{{ URL::to(env('WEBHOOK_PREFIX','').'payment_hook/'.$account->account_key.'/'.GATEWAY_GOCARDLESS) }}">
                ...
                ->value(1) !!}
                    ...
                    <div class="stripe-webhook-options">
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-sm-8 help-block">
                                <input type="text" class="form-control" onfocus="$(this).select()" readonly
                                       value="{{ URL::to(env('WEBHOOK_PREFIX','').'payment_hook/'.$account->account_key.'/'.GATEWAY_STRIPE) }}">
