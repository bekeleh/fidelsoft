...
<html lang="en">
<head>
    <title>{{trans('texts.team_source')}}</title>
    <meta charset="utf-8">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="$('#avatar-upload-form').submit();">Save
                    changes
                </button>
            </div>
        </div>
...
<div id="app">
    @if(Auth::user())
        ...
        @endif
        <div @if(!isset($entityType)) style="position: absolute; top: 50px; width: 100%; height: calc(100% - 62px);" @endif>
            @yield('content')
        </div>
    @else
        @yield('content')
