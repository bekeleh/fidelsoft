            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    @if ($account->customLabel('project1') && $project->custom_value1)
                        {{ $account->present()->customLabel('project1') . ': ' }} {!! nl2br(e($project->custom_value1)) !!}
                        <br/>
                    @endif
                    @if ($account->customLabel('project2') && $project->custom_value2)
                        {{ $account->present()->customLabel('project2') . ': ' }} {!! nl2br(e($project->custom_value2)) !!}
                        <br/>
                    @endif
                        ...
                        <table class="table" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td style="text-align: right">
                                    {{ Utils::formatTime(isset($chartData->duration)? $chartData->duration:0) }}
                                    {{--                                    @if (isset($project->budgeted_hours) ? (floatval($project->budgeted_hours)):false && isset($chartData->duration))--}}
            ...
            window.myChart = new Chart(ctx, {
                ...
                options: {
                    ...
                    scales: {
                        ...
                        yAxes: [{
                            ticks: {
                                @if (isset($project->budgeted_hours) && isset($chartData->duration))
