    ...
    <div class="row">
        ...
        @else
            ...
            @if ($account->client_number_counter)
                {!! Former::populateField('id_number', $account->getNextInvoiceNumber()) !!}
            @endif
        @endif
        <div class="row">
            <div class="col-md-6">
                <div class="panel panel-default">
                    ...
                    {!! Former::text('id_number')->placeholder($account->clientNumbersEnabled() ? $account->getNextInvoiceNumber() : ' ') !!}
