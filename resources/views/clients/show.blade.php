        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <p><i class="fa fa-id-number"
                  style="width: 20px"></i>{{ trans('texts.id_number').': '.$client->id_number }}</p>
                  @endif
                  @if ($client->vat_number)
                  <p><i class="fa fa-vat-number"
                      style="width: 20px"></i>{{ trans('texts.vat_number').': '.$client->vat_number }}</p>
                      @endif
            ...
            <h3>{{ trans('texts.standing') }}
                <table class="table" style="width:100%">
                    <tr>
                        ...
                        <td style="text-align: left">{{ Utils::formatMoney($client->paid_to_date, $client->getCurrencyId()) }}
                        </td>
                    </tr>
                    <tr>
                        <td><small>{{ trans('texts.balance') }}</small></td>
                        <td style="text-align: left">{{ Utils::formatMoney($client->balance, $client->getCurrencyId()) }}
                        </td>
                    </tr>
                    @if ($credit > 0)
                    <tr>
                        <td><small>{{ trans('texts.credit') }}</small></td>
                        <td style="text-align: left">{{ Utils::formatMoney($credit, $client->getCurrencyId()) }}
                        </td>
                    </tr>
                    @endif
                </table>
