        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
                <li class="with-img">
                    <a href="{{ route('dashboard') }}" style="font-size: 13px;">
                        <img src="/img/no-image.png" alt="" width="155" height="155" class="media-object"
            ...
            <ul class="nav navbar-nav navbar-right">
                <form class="navbar-form navbar-left dropdown" role="search">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" id="overall-search-output"
                        onClick="event.stopPropagation();"
                        style="margin-top: 4px; margin-right: 15px; width: 250px; padding: 4px 5px; max-height: 250px; overflow: auto;">
                        <li style="font-style: italic; text-align: center; font-size: 13px;">Type something.</li>
                    </ul>
                </form>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                       style="padding-right: 9px; padding-left: 9px;"><i class="fa fa-plus fa-fw"></i></a>
                    <ul class="dropdown-menu dropdown-menu-right"
                        style="margin-top: -3px; margin-right: -6px; margin-top: -3px; padding: 4px 5px;">
                        <li><a href="#" style="padding: 5px 6px;">Create wiki</a></li>
                        <li><a href="#" style="padding: 5px 6px;">Create space</a></li>
                        <li class="divider" style="margin: 0px;"></li>
                        <li><a href="#" style="padding: 5px 6px;">Invite user</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                       style="padding-right: 9px; padding-left: 9px; position: relative;">
                        <i class="fa fa-bell fa-fw"></i>
                        @if(isset($notifications) ?: $notifications->count())
                            <span class="unread-notification"
                                  style="background-color: #03A9F4; height: 11px; width: 11px; display: inline-block; border-radius: 50%; position: absolute; top: 13px; right: 8px; border: 2px solid #fbfbfb;"></span>
                        @endif
                    </a>
                    <div class="dropdown-menu dropdown-menu-right" onClick="event.stopPropagation();"
                         style="margin-top: -3px; margin-right: -6px; width: 420px; padding: 0;">
                        <div class="menu-notifications">
                            <div class="notification-head" style="padding: 12px 15px;">
                                ...
                                <div class="pull-right" style="height: 18px; display: flex; align-items: center;">
                                    @if(isset($notifications) ?: $notifications->count())
                                        <a href="{{ route('notifications.readall', [$team->slug, Auth::user()->slug]) }}"><i
                                                    class="fa fa-eye fa-fw icon" data-toggle="tooltip"
                                                    data-position="top" title="Mark all as read"></i></a>
                                    @endif
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="notification-body"
                                 style="max-height: 260px; overflow: auto; margin-bottom: 15px;">
                                                    ...
                                                    <a href="{{ $notification->url }}">
                                                        <div class="media">
                                                            <div class="pull-left event-user-image" href="">
                                                                ...
                                                                @if($user_image)
                                                                    <img class="media-object"
                                                                         style="border-radius: 3px;"
                                                                         src="/img/avatars/{{ $user_image }}" width="42"
                                                                         height="42" alt="Image">
                                                                @else
                                                                    <img class="media-object"
                                                                         style="border-radius: 3px;"
                                                                         src="/img/no-image.png" width="44" height="44"
                                                                         alt="Image">
                                                                @endif
                                                            </div>
                                                            <div class="media-body">
                                                                ...
                                                                <div class="pull-left"
                                                                     style="position: relative; top: -3px; width: 89%;">
                                                                    {{ $notification->text }}
                                                                </div>
                                                                <div class="clearfix"></div>
                                                                <p class="text-muted"
                                                                   style="font-size: 13px; color: #b7b7b7;">{{ $notification->created_at->diffForHumans() }}</p>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                ...
                                @else
                                    <div style="font-size: 12px; text-align: center; padding: 2px 15px 20px; color: #777;">
                                        <i class="fa fa-bell-o"
                                           style="transform: rotate(24deg); font-size: 14px; margin-right: 4px; position: relative; top: -2px;"></i>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" style="margin-top: -3px; padding: 4px 5px;">
                        <li><a href="{{ route('users.show', [Auth::user()->username]) }}"
                               style="padding: 5px 6px;">Profile</a></li>
                        <li><a href="{{ route('settings.profile', [$team->slug, Auth::user()->slug]) }}"
                               style="padding: 5px 6px;">Settings</a></li>
