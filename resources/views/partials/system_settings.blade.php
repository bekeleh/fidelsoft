<div class="panel panel-default">
    <div class="panel-heading" style="color: white;background-color: #777 !important;">
        <h3 class="panel-title in-bold-white">{{ trans('texts.application_settings') }}</h3>
    </div>
...
<div class="panel panel-default">
    <div class="panel-heading" style="color: white;background-color: #777 !important;">
        <h3 class="panel-title in-bold-white">{{ trans('texts.database_connection') }}</h3>
    </div>
    <div class="panel-body form-padding-right">
        {!! Former::select('database[default]')->label('driver')->options(['mysql' => 'MySQL', 'pgsql' => 'PostgreSQL',
...
@if (!isset($_ENV['POSTMARK_API_TOKEN']))
    <div class="panel panel-default">
        <div class="panel-heading" style="color: white;background-color: #777 !important;">
            <h3 class="panel-title in-bold-white">{{ trans('texts.email_settings') }}</h3>
        </div>
        <div class="panel-body form-padding-right">
