 ...
 * [Fork](https://github.com/invoiceninja/invoiceninja#fork-destination-box) the [Fidel repository](https://github.com/invoiceninja/invoiceninja)
 ...
 * Push your branch and create a PR against the Fidel **`develop`** branch
...
## Translations
For helping us with translating Fidel, please use [Transifex](https://www.transifex.com/invoice-ninja/invoice-ninja/).
