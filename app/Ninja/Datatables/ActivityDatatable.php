            ...
            [
                ...
                function ($model) {
                    $data = [
                        ...
                        'purchase_invoice' => $model->purchase_invoice ? link_to('/purchase_invoices/' . $model->purchase_invoice_public_id, $model->is_recurring ? trans('texts.recurring_invoice') : $model->purchase_invoice_number)->toHtml() : null,
