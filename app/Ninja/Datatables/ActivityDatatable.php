            ...
            [
                ...
                function ($model) {
                    $data = [
                        ...
                        'invoice' => $model->invoice_number ? link_to('/invoices/' . $model->invoice_public_id, $model->is_recurring ? trans('texts.recurring_invoice') : $model->invoice_number)->toHtml() : null,
