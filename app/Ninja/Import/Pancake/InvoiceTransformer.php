    ...
    public function transform($data)
    {
        ...
        return new Item($data, function ($data) use ($clientId) {
            return [
                ...
                'invoice_items' => [
                    [
                        'name' => $data->item_1_gross_discount > 0 ? trans('texts.discount') : $data->item_1_name,
                    ...
                    [
                        'name' => $data->item_2_gross_discount > 0 ? trans('texts.discount') : $data->item_2_name,
                    ...
                    [
                        'name' => $data->item_3_gross_discount > 0 ? trans('texts.discount') : $data->item_3_name,
                    ...
                    [
                        'name' => $data->item_4_gross_discount > 0 ? trans('texts.discount') : $data->item_4_name,
                    ...
                    [
                        'name' => $data->item_5_gross_discount > 0 ? trans('texts.discount') : $data->item_5_name,
                    ...
                    [
                        'name' => $data->item_6_gross_discount > 0 ? trans('texts.discount') : $data->item_6_name,
                    ...
                    [
                        'name' => $data->item_7_gross_discount > 0 ? trans('texts.discount') : $data->item_7_name,
                    ...
                    [
                        'name' => $data->item_8_gross_discount > 0 ? trans('texts.discount') : $data->item_8_name,
                    ...
                    [
                        'name' => $data->item_9_gross_discount > 0 ? trans('texts.discount') : $data->item_9_name,
                    ...
                    [
                        'name' => $data->item_10_gross_discount > 0 ? trans('texts.discount') : $data->item_10_name,
                    ...
                    [
                        'name' => $data->item_11_gross_discount > 0 ? trans('texts.discount') : $data->item_11_name,
                    ...
                    [
                        'name' => $data->item_12_gross_discount > 0 ? trans('texts.discount') : $data->item_12_name,
                    ...
                    [
                        'name' => $data->item_13_gross_discount > 0 ? trans('texts.discount') : $data->item_13_name,
                    ...
                    [
                        'name' => $data->item_14_gross_discount > 0 ? trans('texts.discount') : $data->item_14_name,
