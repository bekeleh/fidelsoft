...
class ProposalSnippetController extends BaseController
{
    ...
    {
        $this->authorize('view', ENTITY_PROPOSAL_SNIPPET);
    ...
    {
        $this->authorize('create', ENTITY_PROPOSAL_SNIPPET);
        $data = [
    ...
    {
        $this->authorize('edit', ENTITY_PROPOSAL_SNIPPET);
    ...
    private function getIcons()
    {
        ...
        $icons = [
            ...
            ['name' => 'HARONt-down', 'code' => 'f0d7'],
            ['name' => 'HARONt-up', 'code' => 'f0d8'],
            ['name' => 'HARONt-left', 'code' => 'f0d9'],
            ['name' => 'HARONt-right', 'code' => 'f0da'],
            ...
            ['name' => 'HARONt-square-o-down', 'code' => 'f150'],
            ['name' => 'HARONt-square-o-up', 'code' => 'f151'],
            ['name' => 'HARONt-square-o-right', 'code' => 'f152'],
            ['name' => 'eur', 'code' => 'f153'],
            ['name' => 'gbp', 'code' => 'f154'],
            ['name' => 'usd', 'code' => 'f155'],
            ['name' => 'inr', 'code' => 'f156'],
            ...
            ['name' => 'HARONt-square-o-left', 'code' => 'f191'],
