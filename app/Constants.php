...
if (!defined('APP_NAME')) {
    define('APP_NAME', env('APP_NAME', 'Fidelsoft Business Management Suite'));
    ...
    define('ENTITY_ITEM_REQUEST', 'item_request');
    define('ENTITY_ITEM_TRANSFER', 'item_transfer');
...
//        ENTITY_SCHEDULE_RESOURCE,
    ...
    define('ACCOUNT_PERMISSION_GROUP', 'permission_groups');
...
//  define activities type for bill
    ...
    define('ACTIVITY_TYPE_CREATE_VENDOR_CREDIT', 70);
    define('ACTIVITY_TYPE_UPDATE_VENDOR_CREDIT', 71);
    define('ACTIVITY_TYPE_ARCHIVE_VENDOR_CREDIT', 72);
    define('ACTIVITY_TYPE_DELETE_VENDOR_CREDIT', 73);
    ...
    define('ACTIVITY_TYPE_RESTORE_VENDOR_CREDIT', 87);
...
//    others
    ...
    define('NINJA_APP_URL', env('NINJA_APP_URL', 'https://app.fidel.com.et'));
    ...
    define('REFERRAL_PROGRAM_URL', env('REFERRAL_PROGRAM_URL', 'https://www.fidel.com.et/referral-program/'));
...
// WePay
    ...
    define('WEPAY_THEME', env('WEPAY_THEME', '{"name":"Fidel","primary_color":"777","secondary_color":"777","background_color":"f8f8f8","button_color":"33b753"}'));
