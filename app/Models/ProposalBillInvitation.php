 ...
 * @mixin Eloquent
 */
class ProposalBillInvitation extends EntityModel
{
    use SoftDeletes;
    use Inviteable;

    protected $table = 'proposal_bill_invitations';
    protected $dates = ['deleted_at'];


    public function getEntityType()
    {
        return ENTITY_PROPOSAL_BILL_INVITATION;
    }

    public function proposal()
    {
        return $this->belongsTo('App\Models\BillProposal')->withTrashed();
    }
