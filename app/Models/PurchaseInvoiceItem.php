 ...
 */
class PurchaseInvoiceItem extends EntityModel
{
    use PresentableTrait;
    use SoftDeletes;

    protected $presenter = 'App\Ninja\Presenters\PurchaseInvoiceItemPresenter';
    ...
    {
        return "/purchase_invoice_items/{$this->public_id}/edit";
    }
