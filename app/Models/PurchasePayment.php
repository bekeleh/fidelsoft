...
use App\Events\PurchasePaymentCompleted;
...
class PurchasePayment extends EntityModel
{
    ...
    public function recordRefund($amount = null)
    {
        ...
        if ($refund_change) {
            ...
            Event::fire(new PurchasePaymentWasRefunded($this, $refund_change));
        }
    ...
    public function markVoided()
    {
        ...
        Event::fire(new PurchasePaymentWasVoided($this));
    ...
    public function markComplete()
    {
        ...
        $this->save();
        Event::fire(new PurchasePaymentCompleted($this));
    }
    ...
    public function markFailed($failureMessage = '')
    {
        ...
        $this->save();
        Event::fire(new PurchasePaymentFailed($this));
    }
...
PurchasePayment::creating(function ($payment) {
});

PurchasePayment::created(function ($payment) {
    event(new PurchasePaymentWasCreated($payment));
});
