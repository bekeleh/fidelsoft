...
<?php $__env->startSection('content'); ?>
    ...
    <tr>
        <td style="border-collapse: collapse;">
            <table cellpadding="10" cellspacing="0" border="0" bgcolor="<?php echo e($account->primary_color ?: '#2E2B2B'); ?>" width="600" align="center" class="header"
    ...
    <p style="color: #A7A6A6; font-size: 13px; line-height: 18px; margin: 0 0 7px; padding: 0;">
        ...
        <?php else: ?>
            ...
            <?php if($account->website): ?>
                <strong><a href="<?php echo e($account->present()->website); ?>" style="color: #A7A6A6; text-decoration: none; font-weight: bold; font-size: 10px;"><?php echo e($account->website); ?></a></strong>
            <?php endif; ?>
        <?php endif; ?>
    </p>
<?php $__env->stopSection(); ?>
