    ...
    <div class="row">
        ...
        <?php else: ?>
            ...
            <?php if($account->client_number_counter): ?>
                <?php echo Former::populateField('id_number', $account->getNextInvoiceNumber()); ?>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="panel panel-default">
                    ...
                    <?php echo Former::text('id_number')->placeholder($account->clientNumbersEnabled() ? $account->getNextInvoiceNumber() : ' '); ?>
                    ...
                    ->placeholder(trans('texts.select_client_type'))
                    ...
                    ->placeholder(trans('texts.select_sale_type'))
