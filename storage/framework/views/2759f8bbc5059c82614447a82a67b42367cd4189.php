    ...
    <div class="row">
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $saleSelect.append(new Option("<?php echo e(trans('texts.create_sale')); ?>: $name", '-1'));
                        <?php endif; ?>
                ...
                <?php echo $__env->make('partials/entity_combobox', ['entityType' => ENTITY_SALE], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                if (saleId) {
