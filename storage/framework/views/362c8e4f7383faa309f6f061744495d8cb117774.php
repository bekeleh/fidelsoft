        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading" style="color:white;background-color: #777 !important;">
                    <h3 class="panel-title in-bold-white"><?php echo trans('texts.settings'); ?></h3>
                </div>
                        ...
                        <ul class="nav nav-tabs" role="tablist" style="border: none">
                            <li role="presentation" class="active">
                                <a href="#link" aria-controls="link" role="tab"
                                   data-toggle="tab"><?php echo e(trans('texts.link')); ?></a>
                            </li>
                            <li role="presentation">
                                <a href="#navigation" aria-controls="navigation" role="tab"
                                   data-toggle="tab"><?php echo e(trans('texts.navigation')); ?></a>
                            </li>
                            <li role="presentation">
                                <a href="#messages" aria-controls="messages" role="tab"
                                   data-toggle="tab"><?php echo e(trans('texts.messages')); ?></a>
                            </li>
                            <li role="presentation">
                                <a href="#custom_css" aria-controls="custom_css" role="tab"
                                   data-toggle="tab"><?php echo e(trans('texts.custom_css')); ?></a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="panel-body col-lg-10 col-lg-offset-1">
                                <?php if(Utils::isNinja() && ! Utils::isReseller()): ?>
                                    <?php echo Former::inline_radios('domain_id')
                                            ...
                                            ->radios([
                                                'fidelsoft.com' => ['value' => Domain::INVOICENINJA_COM, 'name' => 'domain_id'],
                                                'fidelsoft.services' => ['value' => Domain::INVOICE_SERVICES, 'name' => 'domain_id'],
                        ...
                        <div role="tabpanel" class="tab-pane" id="messages">
                            <div class="panel-body">
                                ...
                                <?php $__currentLoopData = App\Models\Common\Account::$customMessageTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="color:white;background-color: #777 !important;">
                    <h3 class="panel-title in-bold-white">
                        <?php echo trans('texts.authorization'); ?>
                ...
                <div class="panel-body">
                    <div role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist" style="border: none">
                            <li role="presentation" class="active"><a href="#password" aria-controls="password"
                                                                      role="tab"
                                                                      data-toggle="tab"><?php echo e(trans('texts.password')); ?></a>
                            </li>
                            <li role="presentation"><a href="#checkbox" aria-controls="checkbox" role="tab"
                                                       data-toggle="tab"><?php echo e(trans('texts.checkbox')); ?></a></li>
                            <li role="presentation"><a href="#signature" aria-controls="signature" role="tab"
                                                       data-toggle="tab"><?php echo e(trans('texts.invoice_signature')); ?></a></li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        ...
                        <?php if(count($gateway_types) && count($products)): ?>
                            ...
                            <?php if($account->enable_buy_now_buttons): ?>
                                ...
                                <div role="tabpanel">
                                    <ul class="nav nav-tabs" role="tablist" style="border: none">
                                        <li role="presentation" class="active">
                                            <a href="#buy_now_link" aria-controls="buy_now_link" role="tab"
                                               data-toggle="tab"><?php echo e(trans('texts.link')); ?></a>
                                        </li>
                                        <li role="presentation">
                                            <a href="#form" aria-controls="form" role="tab"
                                               data-toggle="tab"><?php echo e(trans('texts.form')); ?></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tab-content">
...
&lt;/script&gt;</pre>
                        ...
                        <div class="panel-body" id="domainModalHelp" style="display:none">
                            ...
                            <p>Once this is setup please send an email to <?php echo e(env('CONTACT_EMAIL')); ?> and we'll complete
                                the process.</p>
                        </div>
