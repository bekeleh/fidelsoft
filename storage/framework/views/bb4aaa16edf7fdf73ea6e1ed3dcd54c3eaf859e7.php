                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="messages">
                            <div class="panel-body">
                                ...
                                <?php $__currentLoopData = App\Models\Account::$customMessageTypes;
                    ...
                    <div role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist" style="border: none">
                            ...
                            <li role="presentation"><a href="#checkbox" aria-controls="checkbox" role="tab"
                                                       data-toggle="tab"><?php echo e(trans('texts.checkbox')); ?></a>
                            </li>
                            <li role="presentation"><a href="#signature" aria-controls="signature" role="tab"
                                                       data-toggle="tab"><?php echo e(trans('texts.invoice_signature')); ?></a>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content">
...
&lt;/script&gt;</pre>
                        ...
                        <div class="panel-body" id="domainModalHelp" style="display:none">
                            ...
                            <p>Once this is setup please send an email to <?php echo e(env('CONTACT_EMAIL')); ?> and
                                we'll complete the process.</p>
                        </div>
