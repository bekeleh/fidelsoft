...
<head>
    ...
    <!--[if !mso]><!-- -->
    <?php if ($fontsUrl = Utils::getAccountFontsUrl()): ?>
        <link href="<?php echo e($fontsUrl); ?>" rel="stylesheet" type="text/css"/>
    <?php endif; ?>
    <!--<![endif]-->
</head>
<body
    style="color: #000000;<?php echo isset($account) ? $account->getBodyFontCss() : ''; ?>font-size: 12px; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; background: #F4F5F5; margin: 0; padding: 0;"
...
<div id="body_style"
     style="<?php echo isset($account) ? $account->getBodyFontCss() : ''; ?>;color: #2E2B2B; font-size: 16px;
