...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="panel panel-default" style="min-height: 380px">
                    ...
                    <!-- client type -->
                    <?php echo Former::select('client_type_id')->addOption('', '')
        ...
        <script type="text/javascript">
            var clientTypes = <?php echo $clientTypes; ?>;
            var types = <?php echo $saleTypes; ?>;
            var reasons = <?php echo $holdReasons; ?>;
            ...
            <!-- client type -->
            $(function () {
                var clientTypeId = <?php echo e($clientTypePublicId ?: 0); ?>;
                var $client_typeSelect = $('select#client_type_id');
                <?php if(Auth::user()->can('create', ENTITY_CLIENT_TYPE)): ?>
                $client_typeSelect.append(new Option("<?php echo e(trans('texts.create_client_type')); ?>: $name", '-1'));
                        <?php endif; ?>
                ...
                <?php echo $__env->make('partials/entity_combobox', ['entityType' => ENTITY_CLIENT_TYPE], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                if (clientTypeId) {
            ...
            <!-- sale type -->
            $(function () {
                var saleId = <?php echo e($saleTypePublicId ?: 0); ?>;
            ...
            <!-- hold reason -->
            $(function () {
                var reasonId = <?php echo e($holdReasonPublicId ?: 0); ?>;
                var $hold_reasonSelect = $('select#hold_reason_id');
                <?php if(Auth::user()->can('create', ENTITY_HOLD_REASON)): ?>
                $hold_reasonSelect.append(new Option("<?php echo e(trans('texts.create_hold_reason')); ?>: $name", '-1'));
                        <?php endif; ?>
                ...
                <?php echo $__env->make('partials/entity_combobox', ['entityType' => ENTITY_HOLD_REASON], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                if (reasonId) {
