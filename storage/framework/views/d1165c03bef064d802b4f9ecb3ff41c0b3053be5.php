...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('bills.pdf', ['account' => Auth::user()->account, 'pdfHeight' => 800], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php if(Utils::hasFeature(FEATURE_DOCUMENTS) && $invoice->account->invoice_embed_documents): ?>
        <?php if(isset($invoice->documents)): ?>
