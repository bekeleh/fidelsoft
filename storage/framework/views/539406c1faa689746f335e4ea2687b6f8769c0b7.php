    ...
    <div class="row">
        ...
        <?php else: ?>
            ...
            <?php if($account->vendor_number_counter): ?>
                <?php echo Former::populateField('id_number', $account->getNextBillNumber()); ?>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="panel panel-default">
                    ...
                    <?php echo Former::text('id_number')->placeholder($account->vendorNumbersEnabled() ? $account->getNextBillNumber() : ' '); ?>
