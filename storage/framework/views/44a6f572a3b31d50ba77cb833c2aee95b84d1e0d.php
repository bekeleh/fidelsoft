                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-sm-8">
                                        <select name="status_ids[]" class="form-control" style="width: 100%;"
                                            ...
                                            <?php $__currentLoopData = EntityModel::getStatusesFor(ENTITY_INVOICE); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
