...
<?php echo Former::open($url)
    ...
    <!-- Main content area-->
<?php if ($department): ?>
    <?php echo e(Former::populate($department)); ?>
        ...
        <div class="col-lg-10 col-lg-offset-1">
            <div class="panel panel-default">
                <div class="panel-body form-padding-right">
                    <?php echo Former::text('name')->label('texts.department_name'); ?>
...
<?php if (Auth::user()->canCreateOrEdit(ENTITY_MANUFACTURER, $department)): ?>
    <center class="buttons">
        ...
        <?php if ($department): ?>
            <?php echo DropdownButton::normal(trans('texts.more_actions'))
                ->withContents($department->present()->moreActions())
                ->large()
                ->dropup(); ?>
