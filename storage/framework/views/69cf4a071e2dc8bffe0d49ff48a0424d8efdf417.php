<script type="text/javascript">
    ...
    function renderEmailTemplate(str, invoice, entityType) {
        ...
        if (invoice && invoice.invoice_type_id == <?php use App\Models\Gateway;use App\Models\GatewayType;echo e(INVOICE_TYPE_QUOTE); ?> || entityType == '<?php echo e(ENTITY_QUOTE); ?>') {
            ...
            var viewButton = <?php echo json_encode(Form::flatButton('view_invoice', '#777')); ?> +'$password';
        }
        ...
        // Add any available payment method links
                ...
                <?php echo "keys['" . \App\Libraries\Utils::toCamelCase(GatewayType::getAliasFromId($type)) . "Link'] = '" . auth()->user()->account->getBaseUrl() . "/...';"; ?>

                <?php echo "keys['" . \App\Libraries\Utils::toCamelCase(GatewayType::getAliasFromId($type)) . "Button'] = '" . Form::flatButton('pay_now', '#36c157') . "';"; ?>
                                ...
                                <ul>
                                    ...
                                    <?php $__currentLoopData = Gateway::$gatewayTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($account->getGatewayByType($type)): ?>
                                            <?php if($type != GATEWAY_TYPE_TOKEN): ?>
                                                <li>
                                                    $<?php echo e(\App\Libraries\Utils::toCamelCase(GatewayType::getAliasFromId($type))); ?>
