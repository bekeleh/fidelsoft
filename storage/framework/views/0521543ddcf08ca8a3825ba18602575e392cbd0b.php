...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        ...
        function getPDFString(cb) {
            ...
            var fields = <?php echo json_encode(App\Models\Common\Account::$customLabels); ?>;
        ...
        function updateFieldLabels() {
            <?php $__currentLoopData = App\Models\Common\Account::$customLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="panel-body">
                    <div role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist" style="border: none">
                            ...
                            <li role="presentation"><a href="#product_fields" aria-controls="product_fields" role="tab" data-toggle="tab"><?php echo e(trans('texts.product_fields')); ?></a></li>
                            ...
                            <div class="panel-body">
                                ...
                                <?php if(auth()->user()->isEnterprise()): ?>
                                    <?php echo Former::select('background_image_id')
                                            ...
                                            ->addOption('', '')
                                            ->fromQuery(Document::scope()->proposalImages()->get(), function($model) { return $model->name . ' - ' . Utils::formatNumber($model->size / 1000, null, 1) . ' KB'; }, 'public_id')
