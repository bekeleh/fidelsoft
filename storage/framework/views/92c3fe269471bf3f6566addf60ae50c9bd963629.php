...
<?php echo $__env->make('accounts.partials.invoice_fields', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php $__currentLoopData = $invoiceLabels;
            $__env->addLoop($__currentLoopData);
            foreach ($__currentLoopData as $field => $value): $__env->incrementLoopIndices();
                $loop = $__env->getLastLoop(); ?>
                        ...
                        <div role="tabpanel" class="tab-pane" id="invoice_labels">
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <?php $__currentLoopData = App\Models\Account::$customLabels;
                                        $__env->addLoop($__currentLoopData);
