<style type="text/css">
    ...
    .container select,
    .braintree-hosted {
    <?php if(!empty($account)): ?><?php echo $account->getBodyFontCss(); ?><?php else: ?> font-weight: 300;
    ...
    .secure {
        text-align: right;
        float: right;
        background: url(<?php echo e(asset('/images/icon-shield.png')); ?>) right 22px no-repeat;
