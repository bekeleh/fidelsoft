        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <?php if ($vendor->id_number): ?>
                        <p><i class="fa fa-id-number"
                              style="width: 20px"></i><?php echo e(trans('texts.id_number') . ': ' . $vendor->id_number); ?>
                        </p>
                    <?php endif; ?>
                    <?php if ($vendor->vat_number): ?>
                        <p><i class="fa fa-vat-number"
                              style="width: 20px"></i><?php echo e(trans('texts.vat_number') . ': ' . $vendor->vat_number); ?>
                        </p>
                    <?php endif; ?>
                    ...
                    <?php if ($vendor->language): ?>
                        <p><i class="fa fa-language" style="width: 20px"></i><?php echo e($vendor->language->name); ?>
                        </p>
                    <?php endif; ?>
                ...
                <div class="col-md-3">
                    ...
                    <?php $__currentLoopData = $vendor->vendor_contacts;
                ...
                <div class="col-md-4">
                    <h3><?php echo e(trans('texts.standing')); ?>
                        ...
                        <table class="table" style="width:100%">
                            <tr>
                                <td style="vertical-align: top"><small><?php echo e(trans('texts.balance')); ?></small>
                                </td>
                                <td style="text-align: right">
                                    <?php $__currentLoopData = $vendor->getTotalExpenses();
                                    $__env->addLoop($__currentLoopData);
                                    foreach ($__currentLoopData as $currency): $__env->incrementLoopIndices();
                                        $loop = $__env->getLastLoop(); ?>
