            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"
                        id="designHelpModalLabel"><?php echo e(trans('texts.email_designs')); ?></h4>
                </div>
                        ...
                        <div class="panel-body">
                            <div class="row" style="text-align:center">
                                <div class="col-md-4">
                                    ...
                                    <img src="<?php echo e(asset('images/emails/plain.png')); ?>"
                                         class="img-responsive"/>
                                </div>
                                <div class="col-md-4">
                                    <h4><?php echo e(trans('texts.light')); ?></h4><br/>
                                    <img src="<?php echo e(asset('images/emails/light.png')); ?>"
                                         class="img-responsive"/>
                                </div>
                                <div class="col-md-4">
                                    <h4><?php echo e(trans('texts.dark')); ?></h4><br/>
                                    <img src="<?php echo e(asset('images/emails/dark.png')); ?>"
                                         class="img-responsive"/>
                                </div>
                            </div>
                        </div>
