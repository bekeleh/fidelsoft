...
<?php $__env->startSection('top-right'); ?>
    <div class="form-group">
        <input type="text" data-bind="value: filter" placeholder="<?php echo e(trans('texts.filter')); ?>" id="filter"
...
<?php $__env->startSection('content'); ?>
    ...
    <script type="text/javascript">
        ...
        function ViewModel() {
            ...
            self.saveNewStatus = function () {
                ...
                var url = '<?php echo e(url('/task_statuses')); ?>';
            ...
            self.ajax = function (method, url, data, callback) {
                ...
                $.ajax({
                    ...
                    error: function (error) {
                        swal("<?php echo e(trans('texts.error_refresh_page')); ?>");
                    },
                }).always(function () {
                    setTimeout(function () {
            ...
            self.onStatusDragged = function (dragged) {
                ...
                var url = '<?php echo e(url('/task_statuses')); ?>/' + status.public_id();
        ...
        function StatusModel(data) {
            ...
            self.saveEditStatus = function () {
                if (self.name() == self.name.orig()) {
                    ...
                    var url = '<?php echo e(url('/task_statuses')); ?>/' + self.public_id();
            ...
            self.onTaskDragged = function (dragged) {
                ...
                var url = '<?php echo e(url('/task_status_order')); ?>/' + task.public_id();
            ...
            self.archiveStatus = function () {
                ...
                }, "<?php echo e(trans('texts.delete_status')); ?>");
            }
        ...
        function TaskModel(data) {
            ...
            self.saveEditTask = function () {
                ...
                var url = '<?php echo e(url('/tasks')); ?>/' + self.public_id();
            ...
            self.viewTask = function () {
                window.open('<?php echo e(url('/tasks')); ?>/' + self.public_id() + '/edit', 'task');
            }
        ...
        $(function () {
            $('#filter').typeahead({
                ...
                templates: {
                    header: '&nbsp;<span style="font-weight:600;font-size:15px"><?php echo e(trans('texts.clients')); ?></span>'
                }
            }, {
                name: 'data',
                limit: 4,
                ...
                templates: {
                    header: '&nbsp;<span style="font-weight:600;font-size:15px"><?php echo e(trans('texts.projects')); ?></span>'
                }
            ...
            if (<?php echo e($projectPublicId ? 'true' : 'false'); ?>) {
                var project = projectMap[<?php echo e($projectPublicId ?: 0); ?>];
                if (project) {
                    model.filter_project_id(<?php echo e($projectPublicId); ?>);
                    model.filter(project.name());
                }
            } else if (<?php echo e($clientPublicId ? 'true' : 'false'); ?>) {
                var client = clientMap[<?php echo e($clientPublicId ?: 0); ?>];
                if (client) {
                    model.filter_client_id(<?php echo e($clientPublicId); ?>);
    ...
    <ol class="breadcrumb">
        <?php if($project): ?>
            <li><?php echo link_to('/tasks', trans('texts.tasks')); ?></li>
            <li><?php echo $project->present()->link; ?></li>
        <?php elseif($client): ?>
            <li><?php echo link_to('/tasks', trans('texts.tasks')); ?></li>
            <li><?php echo $client->present()->link; ?></li>
        <?php else: ?>
            <li><?php echo link_to('/tasks', trans('texts.tasks')); ?></li>

        <?php endif; ?>
        <li class="active"><?php echo e(trans('texts.kanban')); ?></li>
    </ol>
            ...
            <div class="well kanban-column">
                ...
                <div class="kanban-column-header"
                    ...
                    <div class="pull-right"
                        ...
                        <i class="fa fa-times" title="<?php echo e(trans('texts.archive')); ?>"></i>
                    </div>
                    <br/>
                </div>
                ...
                <div class="kanban-column-row" data-bind="css: { editing: new_task.is_editing_task }, with: new_task"
                    ...
                    <div class="view" data-bind="event: { click: startEditTask }">
                        <a href="#" class="text-muted" style="font-size:13px" data-bind="visible: is_blank">
                            <?php echo e(trans('texts.new_task')); ?>...
                        </a>
                    </div>
                    <div class="edit">
                        <textarea
            ...
            <div class="kanban-column-row" data-bind="css: { editing: is_adding_status }">
                <div class="view" data-bind="event: { click: startNewStatus }" style="padding-bottom: 8px;">
                    <a href="#" class="text-muted" style="font-size:13px">
                        <?php echo e(trans('texts.new_status')); ?>...
                    </a>
                </div>
                <div class="edit">
