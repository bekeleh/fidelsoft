...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <?php echo Former::checkbox('notify_viewed')->label('&nbsp;')->text(trans('texts.email_viewed'))->value(1); ?>

        <?php echo Former::checkbox('notify_paid')->label('&nbsp;')->text(trans('texts.email_paid'))->value(1); ?>

        <?php echo Former::checkbox('notify_approved')->label('&nbsp;')->text(trans('texts.email_approved'))->value(1); ?>
