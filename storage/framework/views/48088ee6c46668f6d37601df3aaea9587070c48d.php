            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"
                        id="myModalLabel"><?php echo e(Auth::user()->registered ? trans('texts.add_company') : trans('texts.sign_up')); ?></h4>
                </div>
                <div class="container" style="width: 100%; padding-bottom: 0px !important">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div id="signUpDiv" onkeyup="validateSignUp()" onclick="validateSignUp()"
                                ...
                                <?php if(Auth::check() && !Auth::user()->registered): ?>
                                    ...
                                    <?php echo Former::populateField('new_username', Auth::user()->username); ?>
                                    ...
                                    <?php if(Utils::isOAuthEnabled() && ! Auth::user()->registered): ?>
                                        <div class="col-md-5">
                                            <?php $__currentLoopData = App\Services\AuthService::$providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e(URL::to('auth/' . $provider)); ?>"
                                        ...
                                        <div class="col-md-6">
                                            <?php else: ?>
                                                <div class="col-md-12">
                                                    ...
                                                    <?php echo Former::text('new_username')
                                                ...
                                                <center>
                                                    <div id="errorTaken" style="display:none">
                                                        &nbsp;<br/><b><?php echo e(trans('texts.email_taken')); ?></b></div>
                                                </center>
                                                <div class="col-md-12">
                        ...
                        <div class="modal-footer" style="margin-top: 0px;padding-right:0px">
                            ...
                            <button type="button" class="btn btn-default" id="closeSignUpButton" data-dismiss="modal"><?php echo e(trans('texts.close')); ?> <i
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger"
                                onclick="logout(true)"><?php echo e(trans('texts.logout_and_delete')); ?></button>
                    </div>
                </div>
            </div>
        </div>
