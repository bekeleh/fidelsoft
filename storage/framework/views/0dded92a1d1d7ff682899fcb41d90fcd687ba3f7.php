<div class="col-lg-<?php echo e(isset($colWidth) ? $colWidth : 3); ?> col-md-6">
    ...
    <div class="table-responsive">
        ...
        <tbody data-bind="sortable: { data: <?php echo e($section); ?>, as: 'field', afterMove: onDragged, allowDrop: <?php echo e(in_array($section, ['product_fields', 'task_fields']) ? 'false' : 'true'); ?> }">
            <tr style="cursor:move;background-color:#fff;margin:1px">
                <td>
                    <i class="fa fa-close" style="cursor:default" title="<?php echo e(trans('texts.remove')); ?>"
