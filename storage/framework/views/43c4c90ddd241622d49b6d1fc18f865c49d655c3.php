        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="color:white;background-color: #777 !important;">
                    <h3 class="panel-title in-bold-white"><?php echo trans('texts.plan_status'); ?></h3>
                </div>
            ...
            <?php if(Utils::isNinjaProd()): ?>
                <div class="modal fade" id="changePlanModel" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-default"
                                        data-dismiss="modal"><?php echo e(trans('texts.go_back')); ?></button>
                                <?php if($planDetails && $planDetails['active']): ?>
                                    <button type="button" class="btn btn-primary" id="changePlanButton"
                                            onclick="confirmChangePlan()"><?php echo e(trans('texts.plan_change')); ?></button>
                                <?php else: ?>
                                    <button type="button" class="btn btn-success" id="changePlanButton"
                                            onclick="confirmChangePlan()"><?php echo e(trans('texts.plan_upgrade')); ?></button>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="color:white;background-color: #777 !important;">
                    <h3 class="panel-title in-bold-white"><?php echo trans('texts.modules'); ?></h3>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <label for="modules" class="control-label col-lg-4 col-sm-4"></label>
                        <div class="col-lg-8 col-sm-8">
                            <?php $__currentLoopData = Account::$modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entityType => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="checkbox">
                                    <label for="modules_<?php echo e($value); ?>">
                                        <input name="modules[]" id="modules_<?php echo e($value); ?>" type="checkbox"
                                               <?php echo e(Auth::user()->account->isModuleEnabled($entityType) ? 'checked="checked"' : ''); ?> value="<?php echo e($value); ?>"><?php echo e(trans("texts.module_{$entityType}")); ?>
                                ...
                                <?php $__currentLoopData = Module::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="checkbox">
                                        <label for="custom_modules_<?php echo e($value); ?>">
                                            <input name="custom_modules[]" id="custom_modules_<?php echo e($value); ?>"
                                                   type="checkbox"
                                                   <?php echo e($value->enabled() ? 'checked="checked"' : ''); ?> value="<?php echo e($value); ?>"><?php echo e(mtrans($value, $value->getLowerName())); ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="color:white;background-color: #777 !important;">
                    <h3 class="panel-title in-bold-white"><?php echo trans('texts.pdf_settings'); ?></h3>
                </div>
                <div class="panel-body">
            ...
            <?php if(! Auth::user()->account->isNinjaOrLicenseAccount()): ?>
                <div class="panel panel-default">
                    <div class="panel-heading" style="color:white;background-color: #777 !important;">
                        <h3 class="panel-title in-bold-white"><?php echo trans('texts.delete_data'); ?></h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <br/>
                        <div class="modal fade" id="confirmPurgeModal" tabindex="-1" role="dialog"
                             aria-labelledby="confirmPurgeModalLabel" aria-hidden="true">
                            <div class="modal-dialog" style="min-width:150px">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title"
                                            id="confirmPurgeModalLabel"><?php echo trans('texts.purge_data'); ?></h4>
                                    </div>
                                    <div class="container" style="width: 100%; padding-bottom: 0px !important">
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                    ...
                                    <div class="modal-footer" style="margin-top: 2px">
                                        <button type="button" class="btn btn-default"
                                                data-dismiss="modal"><?php echo e(trans('texts.go_back')); ?></button>
                                        <button type="button" class="btn btn-danger" id="purgeButton"
                                                onclick="confirmPurge()"><?php echo e(trans('texts.purge_data')); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modal-dialog" style="min-width:150px">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title"
                                                id="confirmCancelModalLabel"><?php echo e($account->hasMultipleAccounts() ? trans('texts.delete_company') : trans('texts.cancel_account')); ?></h4>
                                        </div>
                                        <div class="container" style="width: 100%; padding-bottom: 0px !important">
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    <p>
                                                        <b><?php echo e($account->hasMultipleAccounts() ? trans('texts.delete_company_message') : trans('texts.cancel_account_message')); ?></b>
                                                    </p><br/>
                                        ...
                                        <div class="modal-footer" style="margin-top: 2px">
                                            ...
                                            <button type="button" class="btn btn-danger" id="deleteButton"
                                                    onclick="confirmCancel()"><?php echo e($account->hasMultipleAccounts() ? trans('texts.delete_company') : trans('texts.cancel_account')); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
