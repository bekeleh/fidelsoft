<div class="panel panel-default">
    <div class="panel-heading" style="color: white;background-color: #777 !important;">
        <h3 class="panel-title in-bold-white"><?php echo e(trans('texts.application_settings')); ?></h3>
    </div>
...
<div class="panel panel-default">
    <div class="panel-heading" style="color: white;background-color: #777 !important;">
        <h3 class="panel-title in-bold-white"><?php echo e(trans('texts.database_connection')); ?></h3>
    </div>
    <div class="panel-body form-padding-right">
        <?php echo Former::select('database[default]')->label('driver')->options(['mysql' => 'MySQL', 'pgsql' => 'PostgreSQL',
          'sqlite' => 'SQLite'])->value(isset($_ENV['DB_TYPE']) ? $_ENV['DB_TYPE'] : 'mysql'); ?>
...
<?php if(!isset($_ENV['POSTMARK_API_TOKEN'])): ?>
    <div class="panel panel-default">
        <div class="panel-heading" style="color: white;background-color: #777 !important;">
            <h3 class="panel-title in-bold-white"><?php echo e(trans('texts.email_settings')); ?></h3>
        </div>
        <div class="panel-body form-padding-right">
