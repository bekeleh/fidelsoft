<div class="alert alert-warning" style="display:none" id="keepAliveDiv">
    <?php echo trans('texts.page_expire', ['click_here' => link_to('#', trans('texts.click_here'), ['onclick' => 'keepAlive()'])]); ?>
...
<script type="text/javascript">
    ...
    function warnSessionExpring() {
        ...
        redirectTimer = setTimeout(function () {
            ...
            window.location = '<?php echo e(URL::to($redirectTo)); ?>';
        }, 1000 * 60);
    }
    ...
    function keepAlive() {
        ...
        $.get('<?php echo e(URL::to('/keep_alive')); ?>');
