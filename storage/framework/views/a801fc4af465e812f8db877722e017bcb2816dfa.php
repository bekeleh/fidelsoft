                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-sm-8">
                            <?php $__currentLoopData = \App\Models\Account::$modules;
                            $__env->addLoop($__currentLoopData);
                            foreach ($__currentLoopData as $entityType => $value): $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <div class="checkbox">
                                    <label for="modules_<?php echo e($value); ?>">
                                        <input name="modules[]" id="modules_<?php echo e($value); ?>"
                                               type="checkbox" <?php echo e(Auth::user()->account->isModuleEnabled($entityType) ? 'checked="checked"' : ''); ?>
                                               value="<?php echo e($value); ?>"><?php echo e(trans("texts.module_{$entityType}")); ?>
                            ...
                            <?php if (Utils::isSelfHost()): ?>
                                <?php $__currentLoopData = Module::all();
                                $__env->addLoop($__currentLoopData);
                                    ...
                                    <div class="checkbox">
                                        <label for="custom_modules_<?php echo e($value); ?>">
                                            <input name="custom_modules[]" id="custom_modules_<?php echo e($value); ?>"
                                                   type="checkbox" <?php echo e($value->enabled() ? 'checked="checked"' : ''); ?>
                                                   value="<?php echo e($value); ?>"><?php echo e(mtrans($value, $value->getLowerName())); ?>
