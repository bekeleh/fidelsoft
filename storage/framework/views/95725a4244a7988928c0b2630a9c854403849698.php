...
<?php echo link_to('https://www.fidel.com.et/?tm_source=powered_by', trans('texts.team_source'), ['target' => '_blank', 'title' => trans('texts.created_by', ['name' => trans('texts.team_source')])]); ?>


<?php if(Auth::user()->account->hasFeature(FEATURE_WHITE_LABEL)): ?>
<a href="#" onclick="showWhiteLabelModal()"><?php echo e(trans('texts.white_label_link')); ?>
        ...
        <div class="container" style="width: 100%; padding-bottom: 0px !important">
            <div class="panel panel-default">
                <div class="panel-body">
                    <p>
                        <?php echo e(trans('texts.white_label_text', ['price' => WHITE_LABEL_PRICE])); ?>
