...
<div style="display:inline-block;width:190px">
  ...
  <![endif]-->
    ...
    <table cellspacing="0" cellpadding="0">
        <tr>
            <td align="center" width="180" height="44" bgcolor="<?php echo e($color); ?>"
                style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
                <a href="<?php echo e($link); ?>"
                   style="font-size:16px; font-weight: bold; font-family:sans-serif; text-decoration: none; line-height:44px; width:100%; display:inline-block">
