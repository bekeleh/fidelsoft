...
<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo trans('texts.email_templates'); ?></h3>
        </div>
        <div class="panel-body">
            <div class="row">
                <div role="tabpanel">
                    <ul class="nav nav-tabs" role="tablist" style="border: none">
                        <li role="presentation" class="active"><a href="#invoice" aria-controls="notes" role="tab" data-toggle="tab"><?php echo e(trans('texts.invoice_email')); ?></a></li>
                        <li role="presentation"><a href="#quote" aria-controls="terms" role="tab" data-toggle="tab"><?php echo e(trans('texts.quote_email')); ?></a></li>
                        <li role="presentation"><a href="#proposal" aria-controls="terms" role="tab" data-toggle="tab"><?php echo e(trans('texts.proposal_email')); ?></a></li>
                        <li role="presentation"><a href="#payment" aria-controls="footer" role="tab" data-toggle="tab"><?php echo e(trans('texts.payment_email')); ?></a></li>
                    </ul>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div role="tabpanel">
                    <ul class="nav nav-tabs" role="tablist" style="border: none">
                        <li role="presentation" class="active"><a href="#reminder1" aria-controls="notes" role="tab" data-toggle="tab"><?php echo e(trans('texts.first_reminder')); ?></a></li>
                        <li role="presentation"><a href="#reminder2" aria-controls="terms" role="tab" data-toggle="tab"><?php echo e(trans('texts.second_reminder')); ?></a></li>
                        <li role="presentation"><a href="#reminder3" aria-controls="footer" role="tab" data-toggle="tab"><?php echo e(trans('texts.third_reminder')); ?></a></li>
                        <li role="presentation"><a href="#reminder4" aria-controls="footer" role="tab" data-toggle="tab"><?php echo e(trans('texts.endless_reminder')); ?></a></li>
                    </ul>
                    <div class="tab-content">
