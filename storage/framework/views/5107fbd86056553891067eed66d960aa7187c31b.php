...
<?php $__currentLoopData = App\Models\AccountEmailSettings::$templates;
$__env->addLoop($__currentLoopData);
foreach ($__currentLoopData as $type): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop(); ?>
    <?php $__currentLoopData = ['subject', 'template'];
    $__env->addLoop($__currentLoopData);
...
<?php $__currentLoopData = [TEMPLATE_REMINDER1, TEMPLATE_REMINDER2, TEMPLATE_REMINDER3];
$__env->addLoop($__currentLoopData);
foreach ($__currentLoopData as $type): $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop(); ?>
    <?php $__currentLoopData = ['enable', 'num_days', 'direction', 'field'];
    $__env->addLoop($__currentLoopData);
    foreach ($__currentLoopData as $field): $__env->incrementLoopIndices();
        $loop = $__env->getLastLoop(); ?>
                ...
                <div role="tabpanel">
                    <ul class="nav nav-tabs" role="tablist" style="border: none">
                        ...
                        <li role="presentation"><a href="#quote" aria-controls="terms" role="tab"
                                                   data-toggle="tab"><?php echo e(trans('texts.quote_email')); ?></a>
                        </li>
                        <li role="presentation"><a href="#proposal" aria-controls="terms" role="tab"
                                                   data-toggle="tab"><?php echo e(trans('texts.proposal_email')); ?></a>
                        </li>
                        <li role="presentation"><a href="#payment" aria-controls="footer" role="tab"
                                                   data-toggle="tab"><?php echo e(trans('texts.payment_email')); ?></a>
                        </li>
                    </ul>
                ...
                <div role="tabpanel">
                    <ul class="nav nav-tabs" role="tablist" style="border: none">
                        ...
                        <li role="presentation"><a href="#reminder2" aria-controls="terms" role="tab"
                                                   data-toggle="tab"><?php echo e(trans('texts.second_reminder')); ?></a>
                        </li>
                        <li role="presentation"><a href="#reminder3" aria-controls="footer" role="tab"
                                                   data-toggle="tab"><?php echo e(trans('texts.third_reminder')); ?></a>
                        </li>
                        <li role="presentation"><a href="#reminder4" aria-controls="footer" role="tab"
                                                   data-toggle="tab"><?php echo e(trans('texts.endless_reminder')); ?></a>
                        </li>
                    </ul>
                    <div class="tab-content">
