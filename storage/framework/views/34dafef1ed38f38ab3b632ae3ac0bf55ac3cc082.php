...
<?php $__currentLoopData = App\Models\Account::$customFields;
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"
                        id="patternHelpModalLabel"><?php echo e(trans('texts.pattern_help_title')); ?></h4>
                </div>
                ...
                <div class="container" style="width: 100%; padding-bottom: 0px !important">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <ul>
                                <?php $__currentLoopData = \App\Models\Invoice::$patternFields;
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $field): $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
                                    <?php if ($field == 'date:'): ?>
