...
<?php echo $__env->make('money_script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <script src="<?php echo e(asset('js/d3.min.js')); ?>" type="text/javascript"></script>
...
<?php echo $__env->make('accounts.nav', ['selected' => ACCOUNT_DATA_VISUALIZATIONS, 'advanced' => true], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <div id="tooltip" class="hidden">
        <p>
            ...
            <a class="pull-right" href="#" target="_blank"><?php echo e(trans('texts.view')); ?></a>
        </p>
        <p><?php echo e(trans('texts.total')); ?> <span id="tooltipTotal" class="pull-right"></span></p>
        <p><?php echo e(trans('texts.balance')); ?> <span id="tooltipBalance" class="pull-right"></span></p>
        <p><?php echo e(trans('texts.age')); ?> <span id="tooltipAge" class="pull-right"></span></p>
    </div>

    <form class="form-inline" role="form">
        <?php echo e(trans('texts.group_by')); ?> &nbsp;&nbsp;
        <select id="groupBySelect" class="form-control" onchange="update()" style="background-color:white !important">
            <option value="clients"><?php echo e(trans('texts.clients')); ?></option>
            <option value="invoices"><?php echo e(trans('texts.invoices')); ?></option>
            <option value="products"><?php echo e(trans('texts.products')); ?></option>
        </select>
    ...
    <script type="text/javascript">
        ...
        var accountCurrencyId = <?php echo e(auth()->user()->account->getCurrencyId()); ?>;
        ...
        invoices = _.filter(invoices, function (invoice) {
            ...
            return parseInt(invoice.invoice_type_id) == <?php echo e(INVOICE_TYPE_STANDARD); ?> && !invoice.is_recurring;
        });
            ...
            .rollup(function (d) {
                return {
                    ...
                    paid: d3.sum(d, function (g) {
                        return g.invoice && g.invoice.invoice_status_id == <?php echo e(INVOICE_STATUS_PAID); ?> ? (g.qty * g.cost) : 0;
                    }),
        ...
        _.each(clients, function (client) {
            var currencyId = client.currency_id || <?php echo e(Session::get(SESSION_CURRENCY, DEFAULT_CURRENCY)); ?>;
        ...
        _.each(invoices, function (invoice) {
            var currencyId = invoice.client.currency_id || <?php echo e(Session::get(SESSION_CURRENCY, DEFAULT_CURRENCY)); ?>;
        ...
        _.each(products, function (product) {
            var currencyId = product.values.currency_id || <?php echo e(Session::get(SESSION_CURRENCY, DEFAULT_CURRENCY)); ?>;
