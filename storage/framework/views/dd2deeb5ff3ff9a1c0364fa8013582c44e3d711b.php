...
<?php echo Former::populateField('send_item_details', $account->send_item_details); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading" style="color:white;background-color: #777 !important;">
            <h3 class="panel-title in-bold-white"><?php echo trans('texts.payment_settings'); ?></h3>
        </div>
            ...
            <div class="modal-content">
                            ...
                            <div role="tabpanel">
                                <ul class="nav nav-tabs" role="tablist" style="border: none">
                                    <li role="presentation" class="active">
                                        <a href="#limits" aria-controls="limits" role="tab"
                                           data-toggle="tab"><?php echo e(trans('texts.limits')); ?></a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#fees" aria-controls="fees" role="tab"
                                           data-toggle="tab"><?php echo e(trans('texts.fees')); ?></a>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                <div id="payment-limit-min-container">
                                                    ...
                                                    <div class="input-group" style="padding-bottom:8px">
                                                        ...
                                                        <input type="number" class="form-control" min="0"
                                                               id="payment-limit-min"
                                                               name="limit_min">
                                                    </div>
                                                    <label><input type="checkbox" id="payment-limit-min-enable"
                                                                  name="limit_min_enable"> <?php echo e(trans('texts.enable_min')); ?>
                                            ...
                                            <div class="col-md-6">
                                                <div id="payment-limit-max-container">
                                                    ...
                                                    <div class="input-group" style="padding-bottom:8px">
                                                        <span class="input-group-addon"><?php echo e($currency->symbol); ?></span>
                                                        <input type="number" class="form-control" min="0"
                                                               id="payment-limit-max"
                                                               name="limit_max">
                                                    </div>
                                                    <label><input type="checkbox" id="payment-limit-max-enable"
                                                                  name="limit_max_enable"> <?php echo e(trans('texts.enable_max')); ?>
                                    ...
                                    <div id="feesEnabled" class="panel-body">
                                        ...
                                        <?php if ($account->invoice_item_taxes): ?>
                                            <?php echo Former::select('tax_rate1')
                                                ...
                                                ->fromQuery($taxRates, function ($model) {
                                                    return $model->name . ': ' . $model->rate . '%';
                                                }, 'public_id'); ?>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary"
                            id="modalSave"><?php echo e(trans('texts.save')); ?></button>
                </div>
            </div>
        </div>
    </div>
