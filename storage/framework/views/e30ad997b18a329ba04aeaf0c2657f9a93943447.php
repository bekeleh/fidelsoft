<?php use App\Services\ImportService;
...
<?php echo $__env->make('accounts.nav', ['selected' => ACCOUNT_IMPORT_EXPORT], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <div class="panel panel-default">
        <div class="panel-heading" style="color:white;background-color: #777 !important;">
            <h3 class="panel-title in-bold-white"><?php echo trans('texts.import_data'); ?></h3>
        </div>
        <div class="panel-body">
            ...
            <?php echo Former::select('source')
                ...
                ->options(array_combine(ImportService::$sources, ImportService::$sources))
                ->style('width: 200px'); ?>


            <br/>
            <?php $__currentLoopData = ImportService::$entityTypes;
            $__env->addLoop($__currentLoopData);
            foreach ($__currentLoopData as $entityType): $__env->incrementLoopIndices();
...
<?php echo Former::close(); ?>
    ...
    <script type="text/javascript">
        ...
        function setFileTypesVisible() {
            ...
            <?php $__currentLoopData = ImportService::$entityTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entityType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            $('.<?php echo e($entityType); ?>-file').hide();
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php $__currentLoopData = ImportService::$sources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            if (val === '<?php echo e($source); ?>') {
                <?php $__currentLoopData = ImportService::$entityTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entityType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($source != IMPORT_WAVE && $entityType == ENTITY_PAYMENT): ?>
                // do nothing
                <?php elseif(class_exists(ImportService::getTransformerClassName($source, $entityType))): ?>
