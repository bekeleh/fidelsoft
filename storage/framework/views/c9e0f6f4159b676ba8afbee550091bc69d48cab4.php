        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"
                    id="templateHelpModalLabel"><?php echo e(trans('texts.template_help_title')); ?></h4>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul>
                                    ...
                                    $__env->popLoop();
                                    $loop = $__env->getLastLoop(); ?>
                                    <?php $__currentLoopData = \App\Models\Gateway::$gatewayTypes;
                                    $__env->addLoop($__currentLoopData);
                                    foreach ($__currentLoopData as $type): $__env->incrementLoopIndices();
                                        ...
                                        <?php if ($account->getGatewayByType($type)): ?>
                                            <?php if ($type != GATEWAY_TYPE_TOKEN): ?>
                                                <li>
                                                    $<?php echo e(Utils::toCamelCase(\App\Models\GatewayType::getAliasFromId($type))); ?>
                                                    Link
                                                </li>
                                                <li>
                                                    $<?php echo e(Utils::toCamelCase(\App\Models\GatewayType::getAliasFromId($type))); ?>
