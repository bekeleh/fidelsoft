...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <?php if($account->customLabel('project1') && $project->custom_value1): ?>
                        <?php echo e($account->present()->customLabel('project1') . ': '); ?> <?php echo nl2br(e($project->custom_value1)); ?>

                        <br/>
                    <?php endif; ?>
                    <?php if($account->customLabel('project2') && $project->custom_value2): ?>
                        <?php echo e($account->present()->customLabel('project2') . ': '); ?> <?php echo nl2br(e($project->custom_value2)); ?>
                        ...
                        <table class="table" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td style="text-align: right">
                                    <?php echo e(Utils::formatTime(isset($chartData->duration)? $chartData->duration:0)); ?>
    ...
    <?php if(isset($chartData->duration)): ?>
            ...
            window.myChart = new Chart(ctx, {
                ...
                options: {
                    ...
                    scales: {
                        ...
                        yAxes: [{
                            ticks: {
                                <?php if(isset($project->budgeted_hours) && isset($chartData->duration)): ?>
