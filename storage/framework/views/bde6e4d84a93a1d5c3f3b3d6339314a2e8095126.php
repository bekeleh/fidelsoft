        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <!--- client sale type -->
                    <h4><?php echo e(trans('texts.sale_type')); ?></h4>
                    <?php if(isset($client->saleType)): ?>
                        <?php if(Auth::user()->can('create', ENTITY_SALE_TYPE)): ?>
                            <a href="<?php echo e(URL('/sale_types').'/'.$client->saleType->id); ?>"><?php echo $client->saleType->name; ?></a>
                        <?php else: ?>
                            <?php echo $client->saleType->name; ?>
                    ...
                    <?php endif; ?>
                <!--- client hold reason -->
                    <h4><?php echo e(trans('texts.hold_reason')); ?></h4>
                    <?php if(isset($client->holdReason)): ?>
                        <?php if(Auth::user()->can('create', ENTITY_HOLD_REASON)): ?>
                            <a href="<?php echo e(URL('/hold_reasons').'/'.$client->holdReason->id); ?>"><?php echo $client->holdReason->name; ?></a>
                        <?php else: ?>
                            <?php echo $client->holdReason->name; ?>
