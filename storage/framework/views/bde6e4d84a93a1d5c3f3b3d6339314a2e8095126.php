        ...
        <div class="col-md-5">
            <div class="pull-right">
                ...
                <?php if (!$client->is_deleted): ?>
                    <?php if (app(Gate::class)->check('edit', $client)): ?>
                    ...
                    <?php if (!$client->trashed()): ?>
                        <?php if (app(Gate::class)->check('create', ENTITY_INVOICE)): ?>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <?php if ($client->id_number): ?>
                        <p><i class="fa fa-id-number"
                              style="width: 20px"></i><?php echo e(trans('texts.id_number') . ': ' . $client->id_number); ?>
                        </p>
                    <?php endif; ?>
                    <?php if ($client->vat_number): ?>
                        <p><i class="fa fa-vat-number"
                              style="width: 20px"></i><?php echo e(trans('texts.vat_number') . ': ' . $client->vat_number); ?>
                        </p>
                    <?php endif; ?>
                    ...
                    <?php if (floatval($client->task_rate)): ?>
                        <p><?php echo e(trans('texts.task_rate')); ?>
                            : <?php echo e(Utils::roundSignificant($client->task_rate)); ?></p>
                    <?php endif; ?>
                    ...
                    <?php if ($client->language): ?>
                        <p><i class="fa fa-language" style="width: 20px"></i><?php echo e($client->language->name); ?>
                        </p>
                    <?php endif; ?>
                    <p><?php echo e(trans('texts.payment_terms') . ': ' . trans('texts.payment_terms_net')); ?><?php echo e($client->present()->paymentTerms); ?></p>
                    <!--- client sale type -->
                    <p><?php echo e(trans('texts.sale_type') . ': '); ?><?php echo e($client->present()->saleType); ?></p>
                    <p><?php echo e(trans('texts.hold_reason') . ': '); ?><?php echo e($client->present()->holdReason); ?></p>
                ...
                <div class="col-md-3">
                    ...
                    <?php $__currentLoopData = $client->contacts;
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $contact): $__env->incrementLoopIndices();
                        ...
                        <?php if ($contact->email): ?>
                            <i class="fa fa-envelope"
                               style="width: 20px"></i><?php echo HTML::mailto($contact->email, $contact->email); ?>
                            <br/>
                        <?php endif; ?>
