...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <?php if($vendor): ?>
            ...
            <?php echo Former::populateField('task_rate', floatval($vendor->task_rate) ? Utils::roundSignificant($vendor->task_rate) : ''); ?>

            <?php echo Former::populateField('show_tasks_in_portal', intval($vendor->show_tasks_in_portal)); ?>

            <?php echo Former::populateField('send_reminders', intval($vendor->send_reminders)); ?>

            <?php echo Former::hidden('public_id'); ?>

        <?php else: ?>
            <?php echo Former::populateField('bill_number_counter', 1); ?>
            ...
            <?php if($account->vendor_number_counter): ?>
                <?php echo Former::populateField('id_number', $account->getVendorNextNumber()); ?>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="panel panel-default">
                    ...
                    <?php echo Former::text('id_number')->placeholder($account->vendorNumbersEnabled() ? $account->getVendorNextNumber() : ' '); ?>
                    ...
                    <!-- vendor hold reason -->
                        ...
                        <?php if($account->usesBillCounter()): ?>
                            <?php echo Former::text('bill_number_counter')->label('bill_counter'); ?>
                            ...
                            <ul class="nav nav-tabs" role="tablist" style="border: none">
                                <li role="presentation" class="active">
                                    <a href="#billing_address" aria-controls="billing_address" role="tab"
                                       data-toggle="tab"><?php echo e(trans('texts.billing_address')); ?></a>
                                </li>
                                <li role="presentation">
                                    <a href="#shipping_address" aria-controls="shipping_address" role="tab"
                                       data-toggle="tab"><?php echo e(trans('texts.shipping_address')); ?></a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="nav nav-tabs" role="tablist" style="border: none">
                                <li role="presentation" class="active">
                                    <a href="#settings" aria-controls="settings" role="tab"
                                       data-toggle="tab"><?php echo e(trans('texts.settings')); ?></a>
                                </li>
                                <li role="presentation">
                                    <a href="#notes" aria-controls="notes" role="tab"
                                       data-toggle="tab"><?php echo e(trans('texts.notes')); ?></a>
                                </li>
                                ...
                                <li role="presentation">
                                    <a href="#classify" aria-controls="classify" role="tab"
                                       data-toggle="tab"><?php echo e(trans('texts.classify')); ?></a>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content" style="padding-top:24px;">
...
// show/hide buttons based on loaded values
                if (<?php echo e($vendor && $vendor->hasAddress() ? 'true' : 'false'); ?>) {
                    $('#copyBillingDiv').show();
                }
                if (<?php echo e($vendor && $vendor->hasAddress() ? 'true' : 'false'); ?>) {
