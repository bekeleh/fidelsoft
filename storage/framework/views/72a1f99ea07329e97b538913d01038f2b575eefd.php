        ...
        <div class="modal-content" style="background-color: #f8f8f8">
            ...
            <div class="container" style="width: 100%; padding-bottom: 0px !important">
                        ...
                        <div role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist" style="border: none">
                                <li role="presentation" class="active">
                                    <a href="#preview" aria-controls="preview" role="tab"
                                       data-toggle="tab"><?php echo e(trans('texts.preview')); ?></a>
                                </li>
                                <?php if(Utils::isPro()): ?>
                                ...
                                <li role="presentation">
                                    <a href="#history" aria-controls="history" role="tab"
                                       data-toggle="tab"><?php echo e(trans('texts.history')); ?></a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="modal-footer" style="margin-top: 2px; padding-right:0px">
                    ...
                    <button id="sendEmailButton" type="button" class="btn btn-info"
                            onclick="onConfirmEmailClick()"><?php echo e(trans('texts.send_email')); ?></button>
                </div>
            </div>
        </div>
    </div>
