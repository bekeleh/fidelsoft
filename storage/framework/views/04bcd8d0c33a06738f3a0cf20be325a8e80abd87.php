...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-2">
            <ol class="breadcrumb">
                <li class='active'><?php echo e(trans('texts.dashboard')); ?></li>
            </ol>
        </div>
        <?php if (count($tasks)): ?>
                    ...
                    <div class="pull-right">
                        <?php if (count($currencies) > 1): ?>
                            <div id="currency-btn-group" class="btn-group" role="group"
                                ...
                                <?php $__currentLoopData = $currencies;
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $key => $val): $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
                                    <button type="button"
                                            class="btn btn-normal <?php echo e(array_values($currencies)[0] == $val ? 'active' : ''); ?>"
                                            data-button="<?php echo e($key); ?>"
                        ...
                        <?php endif; ?>
                        <div id="group-btn-group" class="btn-group" role="group"
                             style="border: 1px solid #ccc; margin-left:18px">
                            <button type="button" class="btn btn-normal active" data-button="day"
                                    style="font-weight:normal !important;background-color:white"><?php echo e(trans('texts.day')); ?></button>
                            <button type="button" class="btn btn-normal" data-button="week"
                                    style="font-weight:normal !important;background-color:white"><?php echo e(trans('texts.week')); ?></button>
                            <button type="button" class="btn btn-normal" data-button="month"
                                    style="font-weight:normal !important;background-color:white"><?php echo e(trans('texts.month')); ?></button>
                        </div>
                        <div id="reportrange" class="pull-right"
                             style="background: #fff; cursor: pointer; padding: 9px 14px; border: 1px solid #ccc; margin-top: 0px; margin-left:18px">
                            ...
                            <div style="overflow:hidden">
                                ...
                                <div class="in-bold">
                                    <?php if (count($paidToDate)): ?>
                                        <?php $__currentLoopData = $paidToDate;
                                        $__env->addLoop($__currentLoopData);
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="in-bold">
                                        <?php if (count($averageInvoice)): ?>
                                            <?php $__currentLoopData = $averageInvoice;
                                            $__env->addLoop($__currentLoopData);
                                            foreach ($__currentLoopData as $item): $__env->incrementLoopIndices();
                                                $loop = $__env->getLastLoop(); ?>
                                                <div class="currency currency_<?php echo e($item->currency_id ?: $account->getCurrencyId()); ?>"
                            ...
                            <div style="overflow:hidden">
                                ...
                                <div class="in-bold">
                                    <?php if (count($balances)): ?>
                                        <?php $__currentLoopData = $balances;
                                        $__env->addLoop($__currentLoopData);
                                        foreach ($__currentLoopData as $item): $__env->incrementLoopIndices();
                                            $loop = $__env->getLastLoop(); ?>
                                            <div class="currency currency_<?php echo e($item->currency_id ?: $account->getCurrencyId()); ?>"
            ...
            <div class="col-md-6">
                <div class="panel panel-default dashboard" style="height:320px">
                    ...
                    <ul class="panel-body list-group" style="height:276px;overflow-y:auto;">
                        <?php $__currentLoopData = $activities;
                        $__env->addLoop($__currentLoopData);
                    ...
                    <div class="panel-body" style="height:274px;overflow-y:auto;">
                        <table class="table table-striped">
                            ...
                            foreach ($__currentLoopData as $payment): $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo Invoice::calcLink($payment); ?></td>
                                    <?php if (app(Gate::class)->check('view', [ENTITY_CLIENT, $payment])): ?>
                ...
                <div class="panel panel-default dashboard" style="height:320px">
                    ...
                    <div class="panel-body" style="height:274px;overflow-y:auto;">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $upcoming;
                            $__env->addLoop($__currentLoopData);
                            foreach ($__currentLoopData as $invoice): $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <?php if ($invoice->invoice_type_id == INVOICE_TYPE_STANDARD): ?>
                                    <tr>
                                        <td><?php echo Invoice::calcLink($invoice); ?></td>
                                        <?php if (app(Gate::class)->check('view', [ENTITY_CLIENT, $invoice])): ?>
