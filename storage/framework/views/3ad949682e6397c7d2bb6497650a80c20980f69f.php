    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?php echo e(config('ninja.knowledge_base_url')); ?>"
                   target="_blank"><?php echo e(trans('texts.knowledge_base')); ?></a>
                <a class="btn btn-primary" href="<?php echo e(Utils::getDocsUrl(request()->path())); ?>"
                   target="_blank"><?php echo e(trans('texts.user_guide')); ?></a>
                <a class="btn btn-primary" href="<?php echo e(config('ninja.video_urls.all')); ?>" target="_blank">YouTube <?php echo e(trans('texts.videos')); ?></a>
            </div>
        </div>
    </div>
</div>
