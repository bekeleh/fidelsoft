<script type="text/javascript">
    ...
    function InvoiceModel(data) {
        if (data) {
            ...
            clientModel.id_number("<?php echo e($account->getInvoiceNextNumber()); ?>");
        }
        ...
        self.formatMoney = function (amount) {
            ...
            */
            ...
            var currencyId = (self.client().currency_id() || account.currency_id) || <?php echo e(DEFAULT_CURRENCY); ?>;
            var countryId = (self.client().country_id() || account.country_id) || <?php echo e(DEFAULT_COUNTRY); ?>;
    ...
    function checkInvoiceNumber() {
        var url = '<?php echo e(url('check_invoice_number')); ?><?php echo e($invoice->id ? '/' . $invoice->public_id : ''); ?>?invoice_number=' + encodeURIComponent($('#invoice_number').val());
