        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"
                    id="paymentRefundModalLabel"><?php echo e(trans('texts.refund_payment')); ?></h4>
            </div>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label for="refundAmount"
                                       class="col-sm-offset-2 col-sm-2 control-label"><?php echo e(trans('texts.amount')); ?></label>
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="refundAmount" name="refund_amount"
                                               step="0.01" min="0.01"
                                               placeholder="<?php echo e(trans('texts.amount')); ?>">
                                    </div>
                                    <div class="help-block"><?php echo e(trans('texts.refund_max')); ?> <span
                            ...
                            <div id="refundLocalWarning" class="text-muted">
                                <?php echo e(trans('texts.warning_local_refund')); ?>
            ...
            <div class="modal-footer" style="margin-top: 2px">
                ...
                <button type="button" class="btn btn-primary"
                        id="completeRefundButton"><?php echo e(trans('texts.refund')); ?></button>
            </div>
